...
<html lang="en" data-bs-theme="dark"><head><script src="/bootstrap/assets/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://getbootstrap.comresources/examples/checkout/">
  ...
  <main>
    <div class="py-5">
      ...
      <div class="col-md-7 col-lg-8">
        <form action="/contact/editAccount/${account_id }" method="get" class="needs-validation" novalidate="">
          <div class="row g-3">
            <div class="col-sm-12">
              <label for="firstName" class="form-label">이름</label>
              <input type="text" class="form-control" name="nickname" id="nickname" placeholder="이름" value="" required="">
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                <input type="text" class="form-control" name="account_id" id="account_id" placeholder="ID" value="${account_id }" required="" readonly>
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                <input type="text" class="form-control" name="account_pw" id="account_pw" placeholder="PW" required="">
              <div class="invalid-feedback">
                  패스워드는 필수입니다
                </div>
              </div>
        ...
        <c:if test="${not empty errorMessage}">
          ...
          <button class="btn-success w-100 btn btn-primary btn-lg" type="submit">계정 정보 수정</button>
        </form>
        
        <form method="get" action="/contact/list">
			<button class="btn-danger w-100 btn btn-primary btn-lg" type="submit">취소</button>
        </form>
